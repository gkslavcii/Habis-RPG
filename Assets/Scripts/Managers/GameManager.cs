...
namespace HabisRPG.Managers
{
    public class GameManager : MonoBehaviour
    {
        ...
        {
            // Initialize player
            PlayerCharacter = new CharacterController(playerName, playerClass);
        ...
        public void StartCombat(
            System.Collections.Generic.List<CharacterController> enemies,
        ...
        public void LoadGame(string json)
        {
            ...
            PlayerCharacter = new CharacterController(save.PlayerData);
            PlayerInventory = new Inventory();
            ...
            foreach (var cd in save.ActiveCompanionData)
                Party.ActiveCompanions.Add(new CharacterController(cd));
            foreach (var cd in save.BenchCompanionData)
                Party.BenchCompanions.Add(new CharacterController(cd));
