...
namespace HabisRPG.Party
{
    ...
    public class PartyManager
    {
        ...
        public CharacterController PlayerCharacter { get; private set; }
        public List<CharacterController> ActiveCompanions { get; private set; } = new();
        public List<CharacterController> BenchCompanions { get; private set; } = new();
        ...
        // ── INITIALIZATION ──
        public PartyManager(CharacterController player)
        {
            PlayerCharacter = player;
        }

        // ── RECRUITMENT ──
        public CharacterController RecruitCompanion(string companionId)
        {
            ...
            var companion = new CharacterController(template.Name, template.Class);
        ...
        // ── PARTY MANAGEMENT ──
        public bool SwapToActive(CharacterController companion)
        {
        ...
        public bool SwapToBench(CharacterController companion)
        {
        ...
        public bool SwapCompanions(CharacterController toActive, CharacterController toBench)
        {
        ...
        /// </summary>
        public List<CharacterController> GetCombatParty(bool isBossFight = false)
        {
            var party = new List<CharacterController> { PlayerCharacter };
        ...
        /// </summary>
        public CombatAction GetAIAction(CharacterController companion, float hpPercent)
        {
